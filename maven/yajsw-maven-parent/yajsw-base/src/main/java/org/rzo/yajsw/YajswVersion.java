...
{
	public static final String YAJSW_VERSION = "yajsw-stable-11.03";
	...
	public static final String JAVA_VERSION = System.getProperty("java.vendor")+"/"+System.getProperty("java.version");
}
